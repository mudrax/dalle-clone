...
const CreatePost = () => {
  ...
  const generateImage = async ()=>{
    // alert('openAI API is now not available for free, it was working properly when project was created');
    if(form.prompt){
      try{
        //step 1: to start the loader 
        ...
        const response = await fetch(                      //response
          'https://dall-e-clone-2sgx.onrender.com/api/v1/dalle',
          {
            ...
            body : JSON.stringify({prompt : form.prompt , }) // request
          }
          )

        const data = await response.json();
        
        // step 3: add image in the form 
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[15px] max-w-[500px]">
          ...
          images generated by DALL-E 2.0 and share them with the community
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          <FormField 
            labelName="Your Name"
            type = "text"
            //while making a form the name and prompt for name is same 
            name = "name"
            placeholder = "Jon Doe"
            value = {form.name}
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            rounded-md w-full text-sm sm:w-auto px-5 py-2.5 text-center">
